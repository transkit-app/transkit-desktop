...
export function Config(props) {
    ...
    const [serviceConfig, setServiceConfig] = useConfig(
        instanceKey,
        {
            [INSTANCE_NAME_CONFIG_KEY]: t('services.translate.groq.title'),
        ...
        serviceConfig !== null && (
            ...
            >
                ...
                <div className='config-item'>
                    ...
                    >
                        {t('services.translate.groq.stream')}
                    </Switch>
                </div>
                <div className='config-item'>
                    <Input
                        label={t('services.translate.groq.request_path')}
                        labelPlacement='outside-left'
                ...
                <div className='config-item'>
                    <Input
                        label={t('services.translate.groq.api_key')}
                        labelPlacement='outside-left'
                        type='password'
                ...
                <div className='config-item'>
                    <Input
                        label={t('services.translate.groq.model')}
                        labelPlacement='outside-left'
                ...
                <p className='text-[10px] text-default-700'>{t('services.translate.groq.prompt_description')}</p>
