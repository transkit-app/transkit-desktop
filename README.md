...
Transkit Desktop is a cross-platform translation & OCR app, originally based on [Pot](https://github.com/pot-app/pot-desktop) (GPL-3.0).

## We forked Pot to:
- Optimize for Vietnamese users
- Add professional support & premium features
- Build a sustainable open-source powered product
<br />
<br />
<hr/>
<div align="center">
