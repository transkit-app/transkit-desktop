...
use url::Url;
use webkit2gtk::{
  // webkit2gtk::traits is pub(crate) — not importable from outside the crate.
  // Import only the extension traits actually used in this file; they are
  // all re-exported at the webkit2gtk crate root via `pub use auto::traits::*`.
  NavigationPolicyDecisionExt, SettingsExt, URIRequestExt, UserContentManagerExt,
  WebInspectorExt, WebViewExt,
  LoadEvent, NavigationPolicyDecision, PolicyDecisionType, URIRequest,
